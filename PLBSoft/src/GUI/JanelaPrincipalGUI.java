...
//		shlPlbsoft = ShellHelper.getShellAtivo();
		...
		mntmTanqueRede.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				TanqueRedeGUI tanqueRede = new TanqueRedeGUI(scrolledComposite, SWT.BORDER);
				scrolledComposite.setContent(tanqueRede);
				scrolledComposite.setMinSize(tanqueRede.computeSize(SWT.DEFAULT, SWT.DEFAULT));
			}
		});
		...
		GridData gd_compositeLateral = new GridData(SWT.LEFT, SWT.FILL, false, true, 1, 1);
		...
		btInicio.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		btInicio.setText("Inicio");
		
		Button btTanque = new Button(compositeLateral, SWT.NONE);
		btTanque.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		btTanque.setText("Tanques");
		
		Button btAgenda = new Button(compositeLateral, SWT.NONE);
		btAgenda.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		btAgenda.setText("Agenda");
		
		Button button_3 = new Button(compositeLateral, SWT.NONE);
		button_3.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		...
		scrolledComposite = new ScrolledComposite(shlPlbsoft, SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
		...
		compositeStatus.setLayoutData(new GridData(SWT.FILL, SWT.BOTTOM, true, false, 2, 1));
